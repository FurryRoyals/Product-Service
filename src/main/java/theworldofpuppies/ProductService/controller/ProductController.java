...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse> getProductsByIds(@RequestBody List<String> productIds) {
        try {
            ...
            return ResponseEntity.ok(new ApiResponse("retrieved successfully", true, products));
        ...
        try {
            ...
            if (authResponse.isVerified()) {
                ...
                return ResponseEntity.status(UNAUTHORIZED)
                        .body(new ApiResponse(authResponse.getMessage(), false, UNAUTHORIZED));
            }
            ...
            return ResponseEntity.status(INTERNAL_SERVER_ERROR)
                    .body(new ApiResponse(e.getMessage(), false, INTERNAL_SERVER_ERROR));
        }
    }
