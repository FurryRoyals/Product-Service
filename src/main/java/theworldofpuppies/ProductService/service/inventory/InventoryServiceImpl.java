...
public class InventoryServiceImpl implements InventoryService {
    ...
    public InventoryResponse isProductAvailable(List<InventoryRequest> availabilityRequests) {
        ...
        if (!insufficientProducts.isEmpty()) {
            return new InventoryResponse("Not enough inventory for some products", false, null, null, null);
        }
        return new InventoryResponse("Products are available", true, null, null, product);
    }
